...
The repository currently contains the Phase 0 foundations. There is no
runnable model yet; Phase 1 will turn these foundations into a philosophical
specification.
...
To propose a change, read the [contribution guide](CONTRIBUTING.md). Choices
that settle a disputed reading or impose a consequential project constraint
belong in [decision records](docs/decisions/README.md).
