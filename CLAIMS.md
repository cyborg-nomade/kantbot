...
| <a id="k-028"></a>K-028 | A supported sensible license must be replayable against the actual selected intuitions; declarations of success alone cannot certify object formation or applicability. | Provisional | [Proposed ADR 0007](docs/decisions/0007-replayable-sensible-licenses.md); [sensible procedures](SENSIBLE_PROCEDURES.md) | The corrective implementation binds conditions to procedures and recomputes evidence. Maintainer review precedes acceptance; Phase 3 revisits the bounded procedure vocabulary. |
