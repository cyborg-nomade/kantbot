...
| ID | Claim | Status | Grounds | Consequence |
| --- | --- | --- | --- | --- |
| <a id="k-015"></a>K-015 | Kantbot may use "intuition" as theory-internal terminology for a receptive representation without thereby claiming that the whole model is a human mind; whether the term is warranted depends on declared role criteria. | Open | [Glossary: sensibility and intuition](GLOSSARY.md#sensibility-sinnlichkeit); [ADR 0001](docs/decisions/0001-receptive-representation-terminology.md) | Phase 1 must decide which terminology expresses the experiment without prejudging whether the implemented role succeeds. |
| <a id="k-016"></a>K-016 | A provenance-preserving transformation that combines and retains presented elements may serve as a computational analogue of synthesis. | Current | [A77-83/B102-116](sources/kant/critique-a.md#a77); [Glossary: synthesis](GLOSSARY.md#synthesis-synthesis); [ADR 0002](docs/decisions/0002-a-b-synthesis.md) | The implementation must distinguish synthesis from parsing, concatenation, or opaque feature extraction. |
...
| --- | --- | --- |
| Presentation and intuition | K-001, K-015, K-027 | Open in [ADR 0001](docs/decisions/0001-receptive-representation-terminology.md): define what is given, in what form, and what theory-internal terminology the model should use. |
